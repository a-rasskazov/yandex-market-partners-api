...
------------ | ------------- | ------------- | -------------
**with_turnover** | **bool** | **Только для модели FBY**  Возвращать ли информацию по оборачиваемости.  Значение по умолчанию — &#x60;false&#x60;. Если информация нужна, передавайте значение &#x60;true&#x60;. | [optional] [default to false]
