...
| ------------- | ------------- | ------------- |
| [**confirmBusinessPrices()**](PriceQuarantineApi.md#confirmBusinessPrices) | **POST** /businesses/{businessId}/price-quarantine/confirm | Подтверждение цены на товар, попавшего в карантин (основная цена) |
| [**confirmCampaignPrices()**](PriceQuarantineApi.md#confirmCampaignPrices) | **POST** /campaigns/{campaignId}/price-quarantine/confirm | Подтверждение цены на товар, попавшего в карантин (цена в магазине) |
