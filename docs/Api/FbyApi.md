...
| [**getCampaignFeedCategories()**](FbyApi.md#getCampaignFeedCategories) | **GET** /campaigns/{campaignId}/feeds/categories | Категории магазина |
...
| [**getFeedCategories()**](FbyApi.md#getFeedCategories) | **GET** /campaigns/{campaignId}/feeds/{feedId}/categories | Категории прайс-листа |
...
| [**getOrders()**](FbyApi.md#getOrders) | **GET** /campaigns/{campaignId}/orders | Информация о заказах |
...
| [**getReturn()**](FbyApi.md#getReturn) | **GET** /campaigns/{campaignId}/orders/{orderId}/returns/{returnId} | Информация о возврате или невыкупе |
...
| [**getReturns()**](FbyApi.md#getReturns) | **GET** /campaigns/{campaignId}/returns | Список возвратов и невыкупов |
...
try {
    ...
    echo 'Exception when calling FbyApi->getCampaignFeedCategories: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling FbyApi->getFeedCategories: ', $e->getMessage(), PHP_EOL;
}
```
