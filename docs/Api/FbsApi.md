...
| [**getCampaignFeedCategories()**](FbsApi.md#getCampaignFeedCategories) | **GET** /campaigns/{campaignId}/feeds/categories | Категории магазина |
...
| [**getFeedCategories()**](FbsApi.md#getFeedCategories) | **GET** /campaigns/{campaignId}/feeds/{feedId}/categories | Категории прайс-листа |
...
try {
    ...
    echo 'Exception when calling FbsApi->getCampaignFeedCategories: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling FbsApi->getFeedCategories: ', $e->getMessage(), PHP_EOL;
}
```
