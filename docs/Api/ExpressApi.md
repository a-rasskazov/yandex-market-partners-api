...
| [**getCampaignFeedCategories()**](ExpressApi.md#getCampaignFeedCategories) | **GET** /campaigns/{campaignId}/feeds/categories | Категории магазина |
...
| [**getFeedCategories()**](ExpressApi.md#getFeedCategories) | **GET** /campaigns/{campaignId}/feeds/{feedId}/categories | Категории прайс-листа |
...
try {
    ...
    echo 'Exception when calling ExpressApi->getCampaignFeedCategories: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ExpressApi->getFeedCategories: ', $e->getMessage(), PHP_EOL;
}
```
