...
*DbsApi* | [**getSuggestedOfferMappingEntries**](docs/Api/DbsApi.md#getsuggestedoffermappingentries) | **POST** /campaigns/{campaignId}/offer-mapping-entries/suggestions | Рекомендованные карточки для ваших товаров
...
*DbsApi* | [**setOrderBoxLayout**](docs/Api/DbsApi.md#setorderboxlayout) | **PUT** /campaigns/{campaignId}/orders/{orderId}/boxes | Подготовка заказа (FBS)
...
*ExpressApi* | [**getCampaignFeedCategories**](docs/Api/ExpressApi.md#getcampaignfeedcategories) | **GET** /campaigns/{campaignId}/feeds/categories | Категории магазина
...
*ExpressApi* | [**getFeedCategories**](docs/Api/ExpressApi.md#getfeedcategories) | **GET** /campaigns/{campaignId}/feeds/{feedId}/categories | Категории прайс-листа
...
*FbsApi* | [**getCampaignFeedCategories**](docs/Api/FbsApi.md#getcampaignfeedcategories) | **GET** /campaigns/{campaignId}/feeds/categories | Категории магазина
...
*FbsApi* | [**getFeedCategories**](docs/Api/FbsApi.md#getfeedcategories) | **GET** /campaigns/{campaignId}/feeds/{feedId}/categories | Категории прайс-листа
...
*FbyApi* | [**getCampaignFeedCategories**](docs/Api/FbyApi.md#getcampaignfeedcategories) | **GET** /campaigns/{campaignId}/feeds/categories | Категории магазина
...
*FbyApi* | [**getFeedCategories**](docs/Api/FbyApi.md#getfeedcategories) | **GET** /campaigns/{campaignId}/feeds/{feedId}/categories | Категории прайс-листа
...
*FbyApi* | [**getOrders**](docs/Api/FbyApi.md#getorders) | **GET** /campaigns/{campaignId}/orders | Информация о заказах
...
*FbyApi* | [**getReturn**](docs/Api/FbyApi.md#getreturn) | **GET** /campaigns/{campaignId}/orders/{orderId}/returns/{returnId} | Информация о возврате или невыкупе
...
*FbyApi* | [**getReturns**](docs/Api/FbyApi.md#getreturns) | **GET** /campaigns/{campaignId}/returns | Список возвратов и невыкупов
